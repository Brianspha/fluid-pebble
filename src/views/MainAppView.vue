  ...
  <v-container fluid>
    <v-row class="headingRow"
      ><div class="font-weight-black font-italic text-h3">
        <a href="./index.html">FluidPebble</a>
      </div>
      <v-spacer></v-spacer>
      <v-btn
        style="
    ...
    <v-row align="center" justify="center">
      <v-btn v-if="$store.state.connected"
        style="
          background-color: #6bdcc6;
          color: white;
          border-radius: 5px;
        ...
        outlined
        text
        @click="$store.state.returnNFTDialog=true"
      >
        Return NFT
      </v-btn></v-row
    >
...
import ReturnNFTModal from '../modals/ReturnNFTModal.vue';
