...
class Provider {
    ...
    getBalance(addressOrName, blockTag) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.resolveApi;
            let address = yield this._resolveAddress(addressOrName);
            if (!address) {
    ...
    getTransactionCount(addressOrName, blockTag) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const address = yield this._resolveEvmAddress(addressOrName);
            let account;
    ...
    _resolveAddress(addressOrName) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield addressOrName;
            const result = yield this.api.query.evmAccounts.accounts(resolved);
    ...
    _resolveEvmAddress(addressOrName) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolved = yield addressOrName;
            if (resolved.length === 42) {
                return resolved;
            }
            const result = yield this.api.query.evmAccounts.evmAddresses(resolved);
            return result.toString();
        });
    }
